...
#define BASEAPP_FLASH_EVT            0x0004
#define BASEAPP_CLOCK_EVT            0x0008   //模块一个时钟
 ...
 */
extern void BaseApp_Init( byte task_id );

/*
 * Task Event Processor for the Serial Transfer Application
 */
extern UINT16 BaseApp_ProcessEvent( byte task_id, UINT16 events );
