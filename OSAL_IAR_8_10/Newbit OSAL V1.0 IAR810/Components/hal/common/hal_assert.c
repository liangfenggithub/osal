...
// #include "mac_rx.h" //del mark
//#include "mac_tx.h"  //del mark
#endif
...
#if (defined HAL_MCU_AVR) || (defined HAL_MCU_CC2430) || (defined HAL_MCU_CC2530) || \
    (defined HAL_MCU_CC2533) || (defined HAL_MCU_MSP430)
    //debugData[DEBUG_DATA_TX_ACTIVE_OFS] = macTxActive; //del mark
//    debugData[DEBUG_DATA_RX_ACTIVE_OFS] = macRxActive; //del mark
#endif
