...
#define HAL_BOARD_NEWBIT_RADIO_SHIELD
#endif
...
#if  (defined (OSC32K_CRYSTAL_INSTALLED) && (OSC32K_CRYSTAL_INSTALLED == TRUE))
...
#elif defined ( HAL_BOARD_NEWBIT_RADIO_SHIELD )
  #define HAL_NUM_LEDS            3
#else
...
#if defined (HAL_BOARD_NEWBIT_RADIO_SHIELD)
  /* 2 - Red */
#define LED2_BV           BV(7)
...
#define PUSH0_POLARITY    ACTIVE_LOW
   
/* S3 */
#define PUSH3_BV          BV(0)
#define PUSH3_SBIT        P1_0
...
/* ----------- Push Buttons ---------- */
#define HAL_PUSH_BUTTON0()        (PUSH1_POLARITY (PUSH0_SBIT))
